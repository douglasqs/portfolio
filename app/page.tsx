...
const content = {
  pt: {
    ...
    featured: [
      ...
      },
      {
        ...
        visual: "lpr",
        number: "04",
        title: "Servidor de eventos LPR e acesso",
    ...
    roles: [
      ...
      {
        period: "2016 — 2017",
        company: "Komlog Importação",
        role: "Estagiário de Assistência Técnica",
        text: "Base técnica em manutenção, diagnóstico e atendimento que deu origem a uma carreira focada em resolver problemas reais com tecnologia.",
      },
    ],
  ...
  en: {
    ...
    featured: [
      ...
      { kind: "public", visual: "face", number: "02", title: "Intelbras Secure Face", description: "AI-powered facial image restoration and standardization pipeline. It validates quality, lighting and face size, enhances images in bulk and integrates results with recognition and access-control systems.", result: "+25% accuracy in critical scenarios", tags: ["Python", "OpenCV", "GFPGAN", "MediaPipe", "Flask"], link: "https://github.com/douglasqs/secure-face-2.0" },
